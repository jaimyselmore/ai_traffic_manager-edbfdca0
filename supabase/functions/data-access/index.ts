...
const TABLE_COLUMNS: Record<string, string[]> = {
  klanten: ['id', 'klantnummer', 'naam', 'contactpersoon', 'email', 'telefoon', 'adres', 'beschikbaarheid', 'interne_notities', 'planning_instructies', 'created_by', 'created_at', 'updated_at'],
