...
const TABLE_COLUMNS: Record<string, string[]> = {
  ...
  projecten: ['id', 'projectnummer', 'volgnummer', 'klant_id', 'omschrijving', 'projecttype', 'datum_aanvraag', 'deadline', 'status', 'adres_klant', 'info_klant', 'opmerkingen', 'account_team', 'creatie_team', 'productie_team', 'aangemaakt_door_naam', 'created_by', 'created_at', 'updated_at'],
  ...
  taken: ['id', 'project_id', 'project_nummer', 'klant_naam', 'fase_id', 'fase_naam', 'werknemer_naam', 'werktype', 'discipline', 'week_start', 'dag_van_week', 'start_uur', 'duur_uren', 'plan_status', 'is_hard_lock', 'aangemaakt_door_naam', 'created_by', 'locked_by', 'created_at', 'updated_at'],
